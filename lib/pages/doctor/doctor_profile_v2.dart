...
final nameEn =
    (doctorData['name_en'] ?? '').toString();

final nameAr =
    (doctorData['name_ar'] ?? nameEn).toString();

final nameKu =
    (doctorData['name_ku'] ?? nameEn).toString();
...
if (lang == 'ar') {
  ...
  about = (doctorData['bio_en'] ??
    ...
    final specialtyAr =
        (doctorData['specialty_ar'] ?? specialtyEn).toString();
    final specialtyKu =
        (doctorData['specialty_ku'] ?? specialtyEn).toString();
...
SliverToBoxAdapter _buildAboutSection(
  ...
  centers,
        ...
        if (centers.isNotEmpty)
          _buildCentersSection(context, centers, schedules, name, imageUrl, exp),
